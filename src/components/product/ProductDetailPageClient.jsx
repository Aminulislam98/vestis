  ...
  return (
    <div className="max-w-7xl sm:max-w-[1100px] 2xl:max-w-[1700px] mx-auto min-h-screen bg-background ">
      ...
      {relatedProducts.length > 0 && (
        <div className=" py-7 sm:py-12 border-t border-border sm:px-3">
          {/* ── Section header */}
          <h2 className="font-body font-bold text-2xl text-foreground mb-8 px-3">
            You May Also Like
          </h2>
            ...
            {relatedProducts.map((item) => {
              ...
              return (
                ...
                >
                  {/* ── Image */}
                  <div
                    className="relative w-full overflow-hidden bg-[#f5f5f5] sm:rounded-2xl"
